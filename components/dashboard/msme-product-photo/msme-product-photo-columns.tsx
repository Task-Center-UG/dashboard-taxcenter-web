...
import { MsmeProductPhotoCellAction } from "./msme-product-photo-cell-action";
import { getImageUrl } from "@/lib/utils";

export type MsmeProductPhotoColumn = {
  id: number;
  title: string;
  description: string;
  image_url: string;
...
export const columns: ColumnDef<MsmeProductPhotoColumn>[] = [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <MsmeProductPhotoCellAction data={row.original} />,
  },
];
