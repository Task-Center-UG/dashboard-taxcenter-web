...
export default function TaxLearningVideoCreateForm() {
  ...
  const mutation = usePostData<any, FormData>({
    ...
    invalidateKeys: [["tax-learning-video-list"]],
    successMessage: "Video pembelajaran pajak berhasil ditambahkan",
    options: {
      onSuccess: () => {
  ...
  return (
    <Card className="max-w-7xl mx-auto border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
      <CardHeader className="bg-zinc-50/50 dark:bg-zinc-900/50 border-b border-zinc-100 dark:border-zinc-800">
        <CardTitle>Tambah Video Pembelajaran Pajak</CardTitle>
        <CardDescription>
          Isi formulir di bawah untuk menambahkan video pembelajaran pajak baru.
        </CardDescription>
      </CardHeader>
