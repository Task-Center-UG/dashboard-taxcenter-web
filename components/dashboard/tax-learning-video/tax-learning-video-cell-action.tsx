...
interface TaxLearningVideoCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function TaxLearningVideoCellAction({ data }: TaxLearningVideoCellActionProps) {
    ...
    options: {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: ["tax-learning-video-list"],
          type: "active",
        });
        setDeleteOpen(false);
      },
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/tax-education/learning-videos/${data.id}/update`)
            }
