...
import { TaxLearningVideoCellAction } from "./tax-learning-video-cell-action";
import { getImageUrl } from "@/lib/utils";

export type TaxLearningVideoColumn = {
  id: number;
  title: string;
  description: string;
  image_url: string;
...
export const columns: ColumnDef<TaxLearningVideoColumn>[] = [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <TaxLearningVideoCellAction data={row.original} />,
  },
];
