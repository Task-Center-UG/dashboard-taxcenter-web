...
import { MsmeAssistanceCellAction } from "./msme-assistance-cell-action";
import { getImageUrl } from "@/lib/utils";

export type MsmeAssistanceColumn = {
  id: number;
  title: string;
  description: string;
  image_url: string;
...
export const columns: ColumnDef<MsmeAssistanceColumn>[] = [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <MsmeAssistanceCellAction data={row.original} />,
  },
];
