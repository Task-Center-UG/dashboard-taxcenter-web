...
interface ResearchCategoryCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function ResearchCategoryCellAction({ data }: ResearchCategoryCellActionProps) {
    ...
    options: {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: ["research-category-list"],
          type: "active",
        });
        setDeleteOpen(false);
      },
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/research/research-categories/${data.id}/update`)
            }
