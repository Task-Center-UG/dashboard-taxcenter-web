...
import { columns, NewsColumn } from "./news-columns";
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Kelola data kegiatan.</p>
        </div>
        <Button
          onClick={() => router.push("/dashboard/activities/news/create")}
