...
interface AfternoonTalkCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function AfternoonTalkCellAction({ data }: AfternoonTalkCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/tax-education/afternoon-talks/${data.id}/update`)
            }
