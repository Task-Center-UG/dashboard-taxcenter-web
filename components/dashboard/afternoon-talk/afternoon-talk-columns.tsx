...
import { AfternoonTalkCellAction } from "./afternoon-talk-cell-action";
import { getImageUrl } from "@/lib/utils";

export type AfternoonTalkColumn = {
  id: number;
  title: string;
  description: string;
  image_url: string;
...
export const columns: ColumnDef<AfternoonTalkColumn>[] = [
  {
  ...
  {
    id: "actions",
    cell: ({ row }) => <AfternoonTalkCellAction data={row.original} />,
  },
];
