...
interface ResearchCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function ResearchCellAction({ data }: ResearchCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/research/research-collaborations/${data.id}/update`)
            }
