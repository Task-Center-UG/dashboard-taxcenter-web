...
import { columns, ResearchColumn } from "./research-columns";
...
export default function ResearchDataTable() {
  ...
  const { data, isLoading } = useGetData<ResearchResponse>({
    key: [
      "research-list",
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Kelola data kerja sama riset.
          </p>
        </div>
        <Button
          onClick={() => router.push("/dashboard/research/research-collaborations/create")}
