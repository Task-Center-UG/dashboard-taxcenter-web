...
import { columns, TrainingColumn } from "./training-columns";
...
export default function TrainingDataTable() {
  ...
  const { data, isLoading } = useGetData<TrainingResponse>({
    key: [
      "training-list",
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button
          onClick={() => router.push("/dashboard/service/training/create")}
