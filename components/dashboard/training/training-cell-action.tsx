...
interface TrainingCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function TrainingCellAction({ data }: TrainingCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/service/training/${data.id}/update`)
            }
