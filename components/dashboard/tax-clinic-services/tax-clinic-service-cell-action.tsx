...
interface TaxClinicServiceCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function TaxClinicServiceCellAction({ data }: TaxClinicServiceCellActionProps) {
    ...
    options: {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: ["tax-clinic-service-list"],
          type: "active",
        });
        setDeleteOpen(false);
      },
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/tax-clinic/services/${data.id}/update`)
            }
