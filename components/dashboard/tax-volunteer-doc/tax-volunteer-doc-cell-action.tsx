...
interface TaxVolunteerDocCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function TaxVolunteerDocCellAction({ data }: TaxVolunteerDocCellActionProps) {
    ...
    options: {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: ["tax-volunteer-doc-list"],
          type: "active",
        });
        setDeleteOpen(false);
      },
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/tax-volunteers/documentations/${data.id}/update`)
            }
