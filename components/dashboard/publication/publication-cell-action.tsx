...
interface PublicationCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function PublicationCellAction({ data }: PublicationCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/activities/publications/${data.id}/update`)
            }
