...
interface SeminarCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function SeminarCellAction({ data }: SeminarCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/activities/seminars/${data.id}/update`)
            }
