...
interface GalleryCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function GalleryCellAction({ data }: GalleryCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/galleries/${data.id}/update`)
            }
