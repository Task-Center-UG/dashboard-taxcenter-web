...
export default function TaxMaterialCreateForm() {
  ...
  const mutation = usePostData<any, FormData>({
    url: "/tax-material",
    invalidateKeys: [["tax-material-list"]],
    successMessage: "Materi pajak berhasil ditambahkan",
    options: {
      onSuccess: () => {
  ...
  return (
    <Card className="max-w-7xl mx-auto border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
      <CardHeader className="bg-zinc-50/50 dark:bg-zinc-900/50 border-b border-zinc-100 dark:border-zinc-800">
        <CardTitle>Tambah Materi Pajak</CardTitle>
        <CardDescription>
          Isi formulir di bawah untuk menambahkan materi pajak baru.
        </CardDescription>
      </CardHeader>
