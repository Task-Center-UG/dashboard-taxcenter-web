...
interface TaxMaterialCellActionProps {
  data: {
    id: number;
    title: string;
  };
...
export function TaxMaterialCellAction({ data }: TaxMaterialCellActionProps) {
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="rounded-xl">
          ...
          <DropdownMenuItem
            onClick={() =>
              router.push(`/dashboard/tax-education/materials/${data.id}/update`)
            }
