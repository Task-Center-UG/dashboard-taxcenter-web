...
export default function ArticleUpdateForm({ id }: { id: string }) {
  ...
  const mutation = usePutData<any, FormData>({
    url: "/article",
    invalidateKeys: [["article-list"], ["article-detail", id]],
    successMessage: "Artikel berhasil diperbarui",
    options: {
      onSuccess: () => {
        router.push("/dashboard/activities/articles");
      },
    },
  });
  ...
  return (
    <Card className="max-w-7xl mx-auto border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
      <CardHeader className="bg-zinc-50/50 dark:bg-zinc-900/50 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <CardDescription>Perbarui data artikel di bawah ini.</CardDescription>
      </CardHeader>
