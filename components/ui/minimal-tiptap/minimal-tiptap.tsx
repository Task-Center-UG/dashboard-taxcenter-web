...
// PERBAIKAN: Menambahkan w-full dan max-w-full pada container toolbar
const Toolbar = ({ editor }: { editor: Editor }) => (
  <div className="shrink-0 overflow-hidden border-b border-border w-full max-w-full">
    <div className="flex h-12 w-full overflow-x-auto p-2 tiptap-toolbar-scroll">
